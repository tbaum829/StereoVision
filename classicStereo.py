...
class ClassicStereo(DisparityAlg):
    def __init__(self, left_path, right_path, outfile="classicStereo.png"):
...
if __name__ == "__main__":
    ...
    classic_stereo = ClassicStereo(left_path="left_floating.png", right_path="right_floating.png")
